...
int main()
{
    ...
    DoublePendulum pend2 = DoublePendulum(Pendulum{9.0, 150, PI / 2.0 + 0.01, Vector2{screenWidth / 2, 350.0}, Vector2{screenWidth / 2, 500.0}, false, 10.0}, Pendulum{9.0, 150, PI / 2.0 + 0.01, Vector2{screenWidth / 2, 500.0}, Vector2{screenWidth / 2, 650.0}, false, 10.0});
